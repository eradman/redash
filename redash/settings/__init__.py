...
ENFORCE_CSRF_FOR_AUTH_USERS = parse_boolean(
    os.environ.get("REDASH_ENFORCE_CSRF_FOR_AUTH_USERS", "false")
)
...
DEFAULT_PROFILE_IMAGE = os.environ.get("REDASH_DEFAULT_PROFILE_IMAGE", "/img/logo_icon.png")
